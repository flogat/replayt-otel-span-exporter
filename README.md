...
**[docs/SPEC_OTEL_EXPORTER_SKELETON.md](docs/SPEC_OTEL_EXPORTER_SKELETON.md)** and **[docs/SPEC_REPLAYT_INTEGRATION_TESTS.md](docs/SPEC_REPLAYT_INTEGRATION_TESTS.md)** (replayt boundary tests — Builder contract when that backlog is active).
...
| `docs/SPEC_REPLAYT_INTEGRATION_TESTS.md` | Replayt integration-tests backlog — boundary scenarios, pins, CI expectations |
